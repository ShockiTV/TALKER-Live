...
local factions = {
    ...
    ecolog = {
        name = "Ecolog",
        style = "a member of the Ecologist faction. They are scientists performing field research in The Zone and are curious, open-minded, cautious and dislike violence." 
    },
    army = {
        name = "Army",
        style = "a member of the Military faction. They are soldiers in the Ukranian army and are reluctant, undisciplined, bitter and emotionally burned-out. Use military terminology, vernacular and slang."
    },
    renegade = {
        name = "Renegade",
    ...
    zombied = {
        name = "Zombied",
        style = "zombified by psy emissions to an almost mindless state where only fragments of memories and personality remains. Incoherent, groaning and barely intelligible. Make it sad and tragic."
    },
    monster = {
        name = "Monster",
