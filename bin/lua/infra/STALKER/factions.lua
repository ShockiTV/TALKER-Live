...
local factions = {
    ...
    freedom = {
        name = "Freedom",
        style = "member of Freedom, a faction that dislikes authority and wants the Zone to be open to all. They are rebellious, relaxed and expressive. "
    },
    bandit = {
        name = "Bandit",
        style = "member of the Bandit faction, a group of gopniks and a vatniks. They are vulgar and rude but like to crack jokes frequently, are opportunistic and lawless but often cowardly. "
    },
    monolith = {
        name = "Monolith",
    ...
    ecolog = {
        name = "Ecolog",
        style = "member of the Ecolog faction. They are scientists performing field research in The Zone and are curious, open-minded, cautious and dislike violence. " 
    },
    army = {
        name = "Army",
        style = "member of the Army faction. They are soldiers in the Ukranian army who are deployed to the Zone to keep the public out for their own safety, as well as to protect the government-funded scientists of the Ecolog faction. They are reluctant, undisciplined, bitter and emotionally burned-out. Use military terminology, vernacular and slang. "
    },
    renegade = {
        name = "Renegade",
        style = "member of the Renegade faction. They are violent criminals who have committed acts so despicable even the Bandit faction barely tolerates them. They are not just ruthless and violent but depraved, vile, crass, deplorable and erratic. Use explicit language. "
    },
    trader = {
        name = "Trader",
        style = "trader and merchant and is persuasive, a little greedy and sometimes resorts to flattery. "
    },
    greh = {
        name = "Sin",
