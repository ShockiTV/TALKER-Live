...
["cit_killers_merc_medic_stalker"] = "a field medic and is clinical, efficient and emotionally distant",             -- Surgeon
	...
	["zat_a2_stalker_mechanic"] = "an experienced technician and recovering alcoholic. He used to hang out in the Skadovsk until a drunken misadventure leading to the death of his close friends Joker and Barge caused him to swear off drinking. He is sarcastic and emotionally unstable",   -- Cardan  
	["jup_b217_stalker_tech"] = "a technician that is competent and friendly but scatterbrained",     -- Nitro  
	...
	["jup_b6_scientist_tech"] = "a technician and mechanic in charge of keeping the instruments and machinery of the scientist bunker in Jupiter running. He also offers repair services to those willing to pay. Unlike most members of the Ecologist faction he is not a scientist. He is cold, disinterested and emotionally flat",            -- Tukarev  
	["jup_b6_scientist_nuclear_physicist"] = "one of the two head scientists of the Jupiter bunker along with Professor Ozersky. He is responsible for convincing the Ukranian Ministry of Education to fund the establishment of the Jupiter bunker after the Brain Scorcher was disabled. The military however refused to offer personnel due to the army's failed assault of the Brain Scorcher as it was turned off, an operation that lead to numerous casualties to the Monolith soldiers and a general embarrassment for the military. This means research progress is frustratingly slow as he's forced to rely on hiring Loners for many supportive tasks. He is anxious, cautious and intelligent", -- Professor Hermann  
	["jup_b6_scientist_biochemist"] = "one of the two head scientists of the Jupiter bunker along with Professor Hermann. He sometimes employs Loners for simple tasks in aid of his research, and also offers safe rides to the mobile lab in Yantar on the military supply helicopter for a steep fee. His primary interest is in the mythical Oasis, and he once studied an artifact brought from there by Colonel Degtaryev - who unfortunately failed to disclose its location. He would pay handsomely for another Oasis artifact. He is pragmatic, quiet and friendly",    -- Professor Ozersky  
...
["merc_pri_a18_mech_mlr"] = "a technician and munitions manager for the local Mercenary outpost under the command of Griffin. He used to work as a security guard for Triple Canopy back in the USA a long time ago, but his expertise in military equipment led him to be recruited by the mercenary company operating in the Zone. He performs repairs and weapons maintenance for Griffin's team, sometimes assisted by Meeker. He is willing to exchange foreign munitions for ammunition and also carries a small assortment of heavier ordnance like explosives and RPG projectiles. He is pragmatic, hardened, and blunt",                           -- Trunk  
["pri_special_trader_mlr"] = "a rare weapons trader and supply manager for the local Mercenary outpost under the command of Griffin. He somehow manages to maintain cordial trade relations with the Monolith faction for access to some of their unique gear, though he refuses to elaborate on how. He has rudimentary mechanical skills and understanding of the internal mechanics of firearms and occasionally helps Trunk with repairs. He is guarded, skittish, standoffish and careful",                       -- Meeker  
["merc_pri_grifon_mlr"] = "the man in charge of the local Mercenary outpost, personally assigned by Dushman to eliminate local threats and establish a base in the outskirts of Pripyat. He was making considerable progress until the recent surge of Monolith activity forced his team to retreat and set up temporary camp in the shelter of a bookshop further from the center of Pripyat than planned. He manages and offers available contracts for local mercenaries, but is primarily a Recon Officer for HQ and will pay well for information, particularly relating to the secret labs and the experimental weapons technology possibly developed there. He is casual, confident and alert",                          -- Griffin  
