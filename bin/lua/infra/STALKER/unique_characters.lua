...
["merc_pri_a18_mech_mlr"] = "a technician and munitions manager for the local Mercenary outpost. He is willing to exchange foreign munitions for ammunition and also carries a small assortment of heavier ordnance like explosives and RPG projectiles. He is pragmatic, hardened, and blunt",                           -- Trunk  
["pri_special_trader_mlr"] = "a rare weapons trader and supply manager for the local Mercenary outpost. He somehow manages to maintain cordial trade relations with the Monolith faction for access to some of their unique gear, though he refuses to elaborate on how. He is guarded, skittish, standoffish and careful",                       -- Meeker  
["merc_pri_grifon_mlr"] = "the man in charge of the local Mercenary outpost. He manages and offers available contracts for local mercenaries, but is primarily a Recon Officer for HQ and will pay well for information. He is casual, confident and alert",                          -- Griffin  
