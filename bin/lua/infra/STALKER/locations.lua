...
local LOCATION_DESCRIPTIONS = {
    ...
    k01_darkscape = "Darkscape is a narrow valley connecting the Cordon to Dark Valley, known for its remote nature and dense forests. Most stalkers avoid it due to this.",
    k02_trucks_cemetery = "Trucks Cemetery is a vast scrapyard to the east of Rostok full of irradiated vehicles from the 1986 disaster.",
    ...
    l03_agroprom = "Agroprom (a heavily contaminated area west of Garbage) is a heavily contaminated area west of Garbage with a %army% HQ and dark, dangerous secrets in its underground.",
    l04_darkvalley = "Dark Valley (located to the east of Garbage) is known for its %bandit% stronghold and the ominous underground lab, a place of horrific experiments.",
    l05_bar = "Rostok (an old industrial area north of Garbage) is repurposed by %dolg% as their main base. It's the largest and safest settlement in the Zone, hosting the famous 100Rads Bar and Arnie's Arena.",
    ...
    l08_yantar = "Yantar (a location haunted by mutants and housing Lab X-16) is Sakharov's bunker-like mobile lab in the middle of Lake Yantar is the %ecolog%'s base of operations for Zone research.",
    ...
    l10_red_forest = "Red Forest (located west of Radar and the Army Warehouses) is a forest whose trees had their leaves turn red after absorbing heavy radiation during the 1986 disaster. It is home to dangerous mutants, many dangerous anomalies and a significant %monolith% presence. A mysterious independent %stalker% called Forester is rumoured to be able to live on his own here.",
    ...
    y04_pole = "The Meadow is a relatively calm area in the south-east of the Zone with occasional %bandit% presence, away from the main conflicts. Most stalkers find it calm but eerie.",
    poselok_ug = "Yuzhniy Town is a ghost town with seemingly no history or evidence that it ever existed. After a massive emission, the empty field between Garbage and Truck Cemetery suddenly revealed the town now named 'Yuzhniy'.",
    promzona = "Promzone is an abandoned train station originally used after the 1986 disaster to transport radioactive garbage from the Northern Regions to the Truck Cemetery, and eventually to Garbage.",
    grimwood = "Grimwood is a region of the forest between the Army Warehouses and the Dead City. Full of mutants and deadly anomalies and with little human life present, making it a good hiding place for those wanting to disappear.",
    -- Special areas
    collaider = "",
    bunker_a1 = "",
