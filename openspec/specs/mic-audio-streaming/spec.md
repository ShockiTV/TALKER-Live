...
Defines how the Lua layer captures microphone audio via the native talker_audio.dll FFI, performs local VAD via the DLL energy-based detector, and streams Opus-encoded audio chunks to talker_service over the existing pollnet WebSocket connection.
