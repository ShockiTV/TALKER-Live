# shared-integration-mocks

## Purpose

Shared mock infrastructure for integration lifecycle tests. Provides `MockStateClient`, `MockPublisher`, `MockLLMClient`, `LifecycleSnapshot`, `run_lifecycle`, and assertion helpers in `tests/integration/conftest.py`, eliminating duplication across per-EventType integration test files.
