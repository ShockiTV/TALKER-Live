...
### Python service is mandatory for AI dialogue
...
### Heartbeat acknowledgement for connection recovery
...
### MCM does not expose AI toggle options
...
### Config getters removed or hardcoded
