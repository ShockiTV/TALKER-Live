...
Defines the Lua-side TTS slot management system for in-engine NPC audio playback. Manages a pool of pre-deployed OGG slot files, round-robin allocation, binary writing, and fire-and-forget 3D spatial audio playback on NPC game objects.
