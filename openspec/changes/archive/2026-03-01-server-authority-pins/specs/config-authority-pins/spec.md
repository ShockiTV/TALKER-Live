...
### Requirement: Pin a config field
...
### Requirement: Unpinned fields pass through
...
### Requirement: Audit logging for pinned field changes
...
### Requirement: Pinned fields reported in config dump
...
### Requirement: LLM provider pin from .env
...
### Requirement: LLM model pin from .env
...
### Requirement: STT method pin from .env
...
### Requirement: OpenAI endpoint override
...
### Requirement: Cache clearing respects pins
