"""Tests for the ws-api-contract — validates docs/ws-api.yaml content.

Each test maps to a spec scenario from:
  openspec/changes/zmq-api-schema/specs/ws-api-contract/spec.md
"""
...
def schema() -> dict:
    """Load and parse docs/ws-api.yaml once for the whole module."""
...
# ── Requirement: YAML schema file at docs/ws-api.yaml ────────
...
class TestSchemaFileStructure:
    ...
    @pytest.mark.parametrize("key", ["version", "envelope", "types", "messages"])
...
class TestEventType:
    ...
    # docs/ws-api.yaml enum, (3) add it here.
