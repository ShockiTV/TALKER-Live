...
# -----------------------------------------------------------------------
# 5.8  ConversationManager tool-loop & _handle_background tests removed
#      (Two-step dialogue flow replaced the tool-based approach.
#       See test_conversation.py for the new ConversationManager tests.)
# -----------------------------------------------------------------------
